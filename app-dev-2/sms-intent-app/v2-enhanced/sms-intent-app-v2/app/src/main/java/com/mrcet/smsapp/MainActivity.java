...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendSms() {
        ...
        try {
            // Strategy 1: smsto: URI (preferred — pre-fills number + body)
            ...
            // Strategy 2: ACTION_SENDTO fallback
            Intent fallback = new Intent(Intent.ACTION_SENDTO);
            fallback.setData(Uri.parse("smsto:" + phoneNumber));
